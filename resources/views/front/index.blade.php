            ...
            <div class="container">
                <div class="navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li>
                            @if($already)
                                <a id="nav_btn" href="{{ route('front.result') }}"
                ...
                <div class="box">
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="col-lg-6 col-lg-offset-3 infos_index">
                            <div class="col-lg-6">
                                <p><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Date de début
                                    : {{ date('d/m/Y', strtotime($quizz->starting_at)) }}</p>
                                <p><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Date de fin
                                    : {{ date('d/m/Y', strtotime($quizz->ending_at)) }}</p>
                            </div>
                            <div class="col-lg-6">
                                <p><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span> Nombre de
                                    questions : {{$quizz->max_question}}</p>
                            </div>
                        </div>
                    </div>
                </div>
